...
namespace CarBook.WebUI.ViewComponents.BlogViewComponents
{
    public class _BlogDetailMainComponentPartial : ViewComponent
    {
        ...
        public _BlogDetailMainComponentPartial(IHttpClientFactory httpClientFactor)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:44358/api/Blogs/" + id);
